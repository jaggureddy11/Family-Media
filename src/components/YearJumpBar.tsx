...
export const YearJumpBar: React.FC<YearJumpBarProps> = ({
  ...
  return (
    <nav
      ...
      className="sticky top-20 z-20 py-3 px-2 bg-black/90 backdrop-blur-md border-b-2 border-slate-800"
    >
      <div className="max-w-6xl mx-auto flex items-center gap-3">
        <div className="flex-shrink-0 text-amber-400 font-bold text-lg hidden sm:flex items-center gap-2">
          ...
          {years.map((year) => {
            ...
            return (
              <button
                ...
                className={`flex-shrink-0 min-h-[56px] min-w-[88px] px-5 py-2.5 rounded-2xl font-bold text-2xl tabular-nums transition-all border-4 focus:outline-none focus:ring-4 focus:ring-amber-400 ${
                  isActive
