  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="bg-zinc-900 border-4 border-zinc-700 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 print:hidden">
          <div>
          ...
          >
            <Printer className="w-8 h-8 mr-2" />
            <Bi en="Print Guide" te="గైడ్ ప్రింట్ చేయండి" />
          </BigButton>
        </div>

        {/* iPhone / iPad Guide Card */}
        <section className="bg-zinc-900 border-6 border-zinc-700 rounded-3xl p-8 sm:p-10 space-y-8">
          <div className="flex items-center gap-4 border-b-4 border-zinc-800 pb-6">
            <div className="w-16 h-16 bg-blue-600/30 border-2 border-blue-400 text-blue-300 rounded-2xl flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-zinc-800/80 border-4 border-zinc-600 rounded-2xl p-6 flex flex-col items-center text-center space-y-4">
              <div className="w-16 h-16 bg-yellow-400 text-black rounded-full flex items-center justify-center text-3xl font-black">
                1
              </div>
            ...
            <div className="bg-zinc-800/80 border-4 border-zinc-600 rounded-2xl p-6 flex flex-col items-center text-center space-y-4">
              ...
              <PlusSquare className="w-12 h-12 text-yellow-400" />
              <h4 className="text-2xl font-bold text-white">
        ...
        <section className="bg-zinc-900 border-6 border-zinc-700 rounded-3xl p-8 sm:p-10 space-y-8">
          <div className="flex items-center gap-4 border-b-4 border-zinc-800 pb-6">
            <div className="w-16 h-16 bg-green-600/30 border-2 border-green-400 text-green-300 rounded-2xl flex items-center justify-center">
              <Smartphone className="w-10 h-10" />
            </div>
            <div>
              <h3 className="text-3xl sm:text-4xl font-extrabold text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-zinc-800/80 border-4 border-zinc-600 rounded-2xl p-6 flex flex-col items-center text-center space-y-4">
              ...
              <MoreVertical className="w-12 h-12 text-green-400" />
              <h4 className="text-2xl font-bold text-white">
